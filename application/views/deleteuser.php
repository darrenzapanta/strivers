                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody class="am">
                     <?php foreach ($am as $am_item): ?>
                        <tr class="modal-trigger" data-toggle="modal" data-target="#modal1" data-id="<?php echo $user_item->id; ?>" id="<?php echo $user_item->id; ?>">
                            <td class="am_code"><?php echo $user_item->username; ?></td>
                            <td class="location"><?php echo $user_item->first_name; ?></td>
                            <td class="totalbalance"><?php echo $user_item->last_name; ?></td>
                            <td class="totalbalance"><?php echo $user_item->last_name; ?></td>
                        </tr>
                     <?php endforeach; ?>  
